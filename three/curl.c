...
const char *STR_HELP="1)显示页面内容\n\
get http://xxx.xxx/xx.html\n\
2)下载文件\n\
download http://xx.xx.xx/aa.bb /home/xx/xx/aaa.bb\n\
3)上传文件到文件系统\n\
copy /home/xx/xx/aaa.bb /home/xxx/upload/file\n\
4)以 POST 方式上传文件到 WEB 服务器\n\
upload /home/xx/xx/aaa.bb http://192.168.1.2:8080/upload\n\
5)显示帮助\n\
help\n\
6)退出程序\n\
exit";
...
static int dispaly_file(const char *url);
...
static int copy_file(const char *filename,const char * path)
{
    ...
    if(curl!=NULL)
    {
        ...
        else
        {
            ...
            CURL_FORMAT_CURL_OFF_T".%061d seconds\n",speed_upload,(total_time/1000000),
